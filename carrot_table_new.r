...
set.seed(100)
c2<-regr_ind(snails[,1:4],snails[,5],crv=1000,mode='linear',Rsq=T)

set.seed(100)
c3<-regr_ind(snails[,1:4],snails[,5],crv=1000,mode='linear',Rsq=T,marg=0.1)
...
set.seed(12399)
c2<-regr_ind(uis[,2:9],uis[,10],crv=1000,mode='linear',cutoff=0.5,Rsq=T)
...
set.seed(12399)
c2<-regr_ind(PBG[,2:5],PBG[,1],crv=1000,mode='linear',cutoff=0.5,Rsq=T)
...
set.seed(12389)
c2<-regr_ind(Rabbit[,2:5],Rabbit[,1],crv=1000,mode='linear',cutoff=0.5,Rsq=T)
...
set.seed(12383);
c1<-regr_ind(kidrecurr[,6:10],kidrecurr[,2],crv=1000,mode='linear',cutoff=0.5)

set.seed(12383);
c2<-regr_ind(kidrecurr[,6:10],kidrecurr[,2],crv=1000,mode='linear',cutoff=0.5,Rsq=T)
...
c1<-regr_ind(kidrecurr[,6:10],kidrecurr[,4],crv=1000,mode='linear',cutoff=0.5)

set.seed(12383);

c2<-regr_ind(kidrecurr[,6:10],kidrecurr[,4],crv=1000,mode='linear',cutoff=0.5,Rsq=T)
...
set.seed(12379)
c1<-regr_ind(hodg[,c(1:2,5:6)],hodg[,3],crv=1000,mode='linear',cutoff=0.5)
#

set.seed(12379)
c2<-regr_ind(hodg[,c(1:2,5:6)],hodg[,3],crv=1000,mode='linear',cutoff=0.5,Rsq=T)
#
...
set.seed(12369)
c2<-regr_ind(bmt[,c(8,10,12:22)],bmt[,2],crv=1000,mode='linear',cutoff=0.5,Rsq=T)
...
set.seed(2345)
c1<-regr_ind(glioma[ind,c(2:4,7)],glioma[ind,5],crv=1000,mode='linear',cutoff=0.5)


set.seed(2345)
c2<-regr_ind(glioma[ind,c(2:4,7)],glioma[ind,5],crv=1000,mode='linear',cutoff=0.5,Rsq=T)
...
set.seed(12359)
c1<-regr_ind(bfeed[ind,3:9],bfeed[ind,1],crv=1000,mode='linear',cutoff=0.5)


set.seed(12359)
c2<-regr_ind(bfeed[ind,3:9],bfeed[ind,1],crv=1000,mode='linear',cutoff=0.5,Rsq=T)
...
set.seed(99)
c1<-regr_ind(esoph[,c(1:3,5)],esoph[,4],crv=1000,mode='linear')


set.seed(99)
c2<-regr_ind(esoph[,c(1:3,5)],esoph[,4],crv=1000,mode='linear',Rsq=T)
...
set.seed(200)
c1<-regr_ind(WeightLoss[,1:6],WeightLoss[,7],crv=1000,cutoff=0.5,mode='linear')


set.seed(200)
c2<-regr_ind(WeightLoss[,1:6],WeightLoss[,7],crv=1000,cutoff=0.5,mode='linear',Rsq=T)
...
source(path2)
set.seed(1234)
c1<-regr_ind(cbind(ifelse(myeloid[ind,2]=="A",1,0),myeloid[ind,5:6]),myeloid[ind,7],crv=1000,mode='linear')

set.seed(1234)
c2<-regr_ind(cbind(ifelse(myeloid[ind,2]=="A",1,0),myeloid[ind,5:6]),myeloid[ind,7],crv=1000,mode='linear',Rsq=T)
...
set.seed(12349)
c1<-regr_ind(Leinhardt[ind,c(1,3:4)],Leinhardt[ind,2],crv=1000,mode='linear',cutoff=0.5)

set.seed(12349)
c2<-regr_ind(Leinhardt[ind,c(1,3:4)],Leinhardt[ind,2],crv=1000,mode='linear',cutoff=0.5,Rsq=T)
...
set.seed(100)
c1<-regr_ind(CO2[,1:4],CO2[,5],1000,mode='linear')

set.seed(100)
c2<-regr_ind(CO2[,1:4],CO2[,5],1000,mode='linear',Rsq=T)
...
set.seed(101)
c1<-regr_ind(OrchardSprays[,2:3],OrchardSprays[,1],1000,mode='linear')


set.seed(101)
c2<-regr_ind(OrchardSprays[,2:3],OrchardSprays[,1],1000,mode='linear',Rsq=T)
...
set.seed(102)
c1<-regr_ind(cbind(Seatbelts[,2:6],Seatbelts[,8]),Seatbelts[,1],1000,mode='linear')


set.seed(102)
c2<-regr_ind(cbind(Seatbelts[,2:6],Seatbelts[,8]),Seatbelts[,1],1000,mode='linear')


set.seed(102)
c3<-regr_ind(cbind(Seatbelts[,2:6],Seatbelts[,8]),Seatbelts[,1],1000,mode='linear')
...
set.seed(103)
c1<-regr_ind(Theoph[,2:4],Theoph[,5],1000,mode='linear')

set.seed(103)
c2<-regr_ind(Theoph[,2:4],Theoph[,5],1000,mode='linear',Rsq=T)
...
set.seed(104)
c1<-regr_ind(airquality[which((is.na(airquality[,1])==FALSE)&(is.na(airquality[,2])==FALSE)),2:5],airquality[which((is.na(airquality[,1])==FALSE)&(is.na(airquality[,2])==FALSE)),1],1000,mode='linear')


set.seed(104)
c2<-regr_ind(airquality[which((is.na(airquality[,1])==FALSE)&(is.na(airquality[,2])==FALSE)),2:5],airquality[which((is.na(airquality[,1])==FALSE)&(is.na(airquality[,2])==FALSE)),1],1000,mode='linear',Rsq=T)
...
set.seed(106)
c1<-regr_ind(mtcars[,2:11],mtcars[,1],1000,cutoff=0.5,mode='linear')

set.seed(106)
c2<-regr_ind(mtcars[,2:11],mtcars[,1],1000,cutoff=0.5,mode='linear',Rsq=T)
...
set.seed(107)
c1<-regr_ind(cbind(npk[,1],apply(as.matrix.noquote(npk),2,as.numeric)[,2:4]),npk[,5],1000,cutoff=0.5,mode='linear')


set.seed(107)
c2<-regr_ind(cbind(npk[,1],apply(as.matrix.noquote(npk),2,as.numeric)[,2:4]),npk[,5],1000,cutoff=0.5,mode='linear', Rsq=T)
...
set.seed(109)
c1<-regr_ind(rock[,1:3],rock[,4],1000,cutoff=0.5,mode='linear')


set.seed(109)
c2<-regr_ind(rock[,1:3],rock[,4],1000,cutoff=0.5,mode='linear',Rsq=T)


set.seed(109)
c3<-regr_ind(rock[,1:3],rock[,4],1000,cutoff=0.5,mode='linear',Rsq=T,marg=0.1)
...
set.seed(110)
c1<-regr_ind(quadr(rock[,1:3]),rock[,4],1000,cutoff=0.5,mode='linear')


set.seed(110)
c2<-regr_ind(quadr(rock[,1:3]),rock[,4],1000,cutoff=0.5,mode='linear',Rsq=T)


set.seed(110)
c3<-regr_ind(quadr(rock[,1:3]),rock[,4],1000,cutoff=0.5,mode='linear',Rsq=T,marg=0.1)
...
set.seed(111)
c1<-regr_ind(stackloss[,1:3],stackloss[,4],1000,cutoff=0.5,mode='linear')


set.seed(111)
c2<-regr_ind(stackloss[,1:3],stackloss[,4],1000,cutoff=0.5,mode='linear',Rsq=T)


set.seed(111)
c3<-regr_ind(stackloss[,1:3],stackloss[,4],1000,cutoff=0.5,mode='linear',Rsq=T,marg=0.1)
...
set.seed(113)
c1<-regr_ind(swiss[,2:6],swiss[,1],1000,cutoff=0.5,mode='linear')


set.seed(113)
c2<-regr_ind(swiss[,2:6],swiss[,1],1000,cutoff=0.5,mode='linear',Rsq=T)


set.seed(113)
c3<-regr_ind(swiss[,2:6],swiss[,1],1000,cutoff=0.5,mode='linear',Rsq=T,marg=0.1)
...
set.seed(114)
c1<-regr_ind(amis[,2:4],amis[,1],1000,cutoff=0.5,mode='linear')


set.seed(114)
c2<-regr_ind(amis[,2:4],amis[,1],1000,cutoff=0.5,mode='linear',Rsq=T)


set.seed(114)
c3<-regr_ind(amis[,2:4],amis[,1],1000,cutoff=0.5,mode='linear',Rsq=T,marg=0.1)
...
set.seed(115)
c1<-regr_ind(cbind(cane[,1:3],cane[,5]),cane[,4],1000,cutoff=0.5,mode='linear')

set.seed(115)
c2<-regr_ind(cbind(cane[,1:3],cane[,5]),cane[,4],1000,cutoff=0.5,mode='linear',Rsq=T)

set.seed(115)
c3<-regr_ind(cbind(cane[,1:3],cane[,5]),cane[,4],1000,cutoff=0.5,mode='linear',Rsq=T,marg=0.1)
...
set.seed(117)
c1<-regr_ind(cbind(Tablrock$tmp[ind],Tablrock$wd[ind],Tablrock$ws[ind],Tablrock$amb[ind],Tablrock$dew[ind],Tablrock$so2[ind],Tablrock$no[ind],Tablrock$no2[ind],Tablrock$nox[ind],Tablrock$co[ind]),Tablrock$ozone[ind],1000,cutoff=0.5,mode='linear')


set.seed(117)
c2<-regr_ind(cbind(Tablrock$tmp[ind],Tablrock$wd[ind],Tablrock$ws[ind],Tablrock$amb[ind],Tablrock$dew[ind],Tablrock$so2[ind],Tablrock$no[ind],Tablrock$no2[ind],Tablrock$nox[ind],Tablrock$co[ind]),Tablrock$ozone[ind],1000,cutoff=0.5,mode='linear',Rsq=T)


set.seed(117)
c3<-regr_ind(cbind(Tablrock$tmp[ind],Tablrock$wd[ind],Tablrock$ws[ind],Tablrock$amb[ind],Tablrock$dew[ind],Tablrock$so2[ind],Tablrock$no[ind],Tablrock$no2[ind],Tablrock$nox[ind],Tablrock$co[ind]),Tablrock$ozone[ind],1000,cutoff=0.5,mode='linear',Rsq=T,marg=0.1)
...
set.seed(118)
c1<-regr_ind(cbind(Track$'100m',Track$'200m',Track$'400m',Track$'800m',Track$'1500m',Track$'3000m'),Track$marathon,1000,mode='linear')


set.seed(118)
c2<-regr_ind(cbind(Track$'100m',Track$'200m',Track$'400m',Track$'800m',Track$'1500m',Track$'3000m'),Track$marathon,1000,mode='linear',Rsq=T)


set.seed(118)
c3<-regr_ind(cbind(Track$'100m',Track$'200m',Track$'400m',Track$'800m',Track$'1500m',Track$'3000m'),Track$marathon,1000,mode='linear',Rsq=T,marg=0.1)
...
set.seed(119)
c1<-regr_ind(cbind(Undergrad$gender,Undergrad$class,Undergrad$gpa,Undergrad$sat),Undergrad$drops,1000,mode='linear')


set.seed(119)
c2<-regr_ind(cbind(Undergrad$gender,Undergrad$class,Undergrad$gpa,Undergrad$sat),Undergrad$drops,1000,mode='linear',Rsq=T)


set.seed(119)
c3<-regr_ind(cbind(Undergrad$gender,Undergrad$class,Undergrad$gpa,Undergrad$sat),Undergrad$drops,1000,mode='linear',Rsq+T,marg=0.1)
...
set.seed(120)
c1<-regr_ind(cbind(Wins$batavg,Wins$rbi,Wins$stole,Wins$strkout,Wins$caught,Wins$errors,Wins$era),Wins$wins,1000,mode='linear')


set.seed(120)
c2<-regr_ind(cbind(Wins$batavg,Wins$rbi,Wins$stole,Wins$strkout,Wins$caught,Wins$errors,Wins$era),Wins$wins,1000,mode='linear',Rsq=T)


set.seed(120)
c3<-regr_ind(cbind(Wins$batavg,Wins$rbi,Wins$stole,Wins$strkout,Wins$caught,Wins$errors,Wins$era),Wins$wins,1000,mode='linear',Rsq=T,marg=0.1)
...
set.seed(121)
c1<-regr_ind(plantTraits[ind,2:10],plantTraits[ind,1],1000,mode='linear')


set.seed(121)
c2<-regr_ind(plantTraits[ind,2:10],plantTraits[ind,1],1000,mode='linear',Rsq=T)


set.seed(121)
c3<-regr_ind(plantTraits[ind,2:10],plantTraits[ind,1],1000,mode='linear',Rsq=T,marg=0.1)
...
set.seed(122)
c1<-regr_ind(plantTraits[ind,11:20],plantTraits[ind,1],1000,mode='linear')

set.seed(122)
c2<-regr_ind(plantTraits[ind,11:20],plantTraits[ind,1],1000,mode='linear',Rsq=T)

set.seed(122)
c3<-regr_ind(plantTraits[ind,11:20],plantTraits[ind,1],1000,mode='linear',Rsq=T,marg=)
...
set.seed(123)
c1<-regr_ind(cbind(algae[ind,1:3],unlist(algae[ind,4]),unlist(algae[ind,5]),unlist(algae[ind,6]),unlist(algae[ind,7]),unlist(algae[ind,8]),unlist(algae[ind,9]),unlist(algae[ind,10]),unlist(algae[ind,11])),unlist(algae[ind,12]),1000,mode='linear')


set.seed(123)
c2<-regr_ind(cbind(algae[ind,1:3],unlist(algae[ind,4]),unlist(algae[ind,5]),unlist(algae[ind,6]),unlist(algae[ind,7]),unlist(algae[ind,8]),unlist(algae[ind,9]),unlist(algae[ind,10]),unlist(algae[ind,11])),unlist(algae[ind,12]),1000,mode='linear',Rsq=T)


set.seed(123)
c3<-regr_ind(cbind(algae[ind,1:3],unlist(algae[ind,4]),unlist(algae[ind,5]),unlist(algae[ind,6]),unlist(algae[ind,7]),unlist(algae[ind,8]),unlist(algae[ind,9]),unlist(algae[ind,10]),unlist(algae[ind,11])),unlist(algae[ind,12]),1000,mode='linear',Rsq=T,marg=0.1)
...
set.seed(124)
c1<-regr_ind(cbind(algae[ind,1:3],unlist(algae[ind,4]),unlist(algae[ind,5]),unlist(algae[ind,6]),unlist(algae[ind,7]),unlist(algae[ind,8]),unlist(algae[ind,9]),unlist(algae[ind,10]),unlist(algae[ind,11])),unlist(algae[,13]),1000,mode='linear')

set.seed(124)
c2<-regr_ind(cbind(algae[ind,1:3],unlist(algae[ind,4]),unlist(algae[ind,5]),unlist(algae[ind,6]),unlist(algae[ind,7]),unlist(algae[ind,8]),unlist(algae[ind,9]),unlist(algae[ind,10]),unlist(algae[ind,11])),unlist(algae[,13]),1000,mode='linear',Rsq=T)

set.seed(124)
c3<-regr_ind(cbind(algae[ind,1:3],unlist(algae[ind,4]),unlist(algae[ind,5]),unlist(algae[ind,6]),unlist(algae[ind,7]),unlist(algae[ind,8]),unlist(algae[ind,9]),unlist(algae[ind,10]),unlist(algae[ind,11])),unlist(algae[,13]),1000,mode='linear',Rsq=T,marg=0.1)
...
set.seed(125)
c1<-regr_ind(cbind(algae[ind,1:3],unlist(algae[ind,4]),unlist(algae[ind,5]),unlist(algae[ind,6]),unlist(algae[ind,7]),unlist(algae[ind,8]),unlist(algae[ind,9]),unlist(algae[ind,10]),unlist(algae[ind,11])),unlist(algae[,14]),1000,mode='linear')


set.seed(125)
c2<-regr_ind(cbind(algae[ind,1:3],unlist(algae[ind,4]),unlist(algae[ind,5]),unlist(algae[ind,6]),unlist(algae[ind,7]),unlist(algae[ind,8]),unlist(algae[ind,9]),unlist(algae[ind,10]),unlist(algae[ind,11])),unlist(algae[,14]),1000,mode='linear',Rsq=T)

set.seed(125)
c2<-regr_ind(cbind(algae[ind,1:3],unlist(algae[ind,4]),unlist(algae[ind,5]),unlist(algae[ind,6]),unlist(algae[ind,7]),unlist(algae[ind,8]),unlist(algae[ind,9]),unlist(algae[ind,10]),unlist(algae[ind,11])),unlist(algae[,14]),1000,mode='linear',Rsq=T,marg=0.1)
...
set.seed(126)
c1<-regr_ind(cbind(algae[ind,1:3],unlist(algae[ind,4]),unlist(algae[ind,5]),unlist(algae[ind,6]),unlist(algae[ind,7]),unlist(algae[ind,8]),unlist(algae[ind,9]),unlist(algae[ind,10]),unlist(algae[ind,11])),unlist(algae[,15]),1000,mode='linear')

set.seed(126)
c2<-regr_ind(cbind(algae[ind,1:3],unlist(algae[ind,4]),unlist(algae[ind,5]),unlist(algae[ind,6]),unlist(algae[ind,7]),unlist(algae[ind,8]),unlist(algae[ind,9]),unlist(algae[ind,10]),unlist(algae[ind,11])),unlist(algae[,15]),1000,mode='linear',Rsq=T)

set.seed(126)
c3<-regr_ind(cbind(algae[ind,1:3],unlist(algae[ind,4]),unlist(algae[ind,5]),unlist(algae[ind,6]),unlist(algae[ind,7]),unlist(algae[ind,8]),unlist(algae[ind,9]),unlist(algae[ind,10]),unlist(algae[ind,11])),unlist(algae[,15]),1000,mode='linear',Rsq=T,marg=0.1)
...
set.seed(127)
c1<-regr_ind(cbind(algae[ind,1:3],unlist(algae[ind,4]),unlist(algae[ind,5]),unlist(algae[ind,6]),unlist(algae[ind,7]),unlist(algae[ind,8]),unlist(algae[ind,9]),unlist(algae[ind,10]),unlist(algae[ind,11])),unlist(algae[,16]),1000,mode='linear')

set.seed(127)
c2<-regr_ind(cbind(algae[ind,1:3],unlist(algae[ind,4]),unlist(algae[ind,5]),unlist(algae[ind,6]),unlist(algae[ind,7]),unlist(algae[ind,8]),unlist(algae[ind,9]),unlist(algae[ind,10]),unlist(algae[ind,11])),unlist(algae[,16]),1000,mode='linear', Rsq=T)

set.seed(127)
c3<-regr_ind(cbind(algae[ind,1:3],unlist(algae[ind,4]),unlist(algae[ind,5]),unlist(algae[ind,6]),unlist(algae[ind,7]),unlist(algae[ind,8]),unlist(algae[ind,9]),unlist(algae[ind,10]),unlist(algae[ind,11])),unlist(algae[,16]),1000,mode='linear',Rsq=T,marg=0.1)
...
set.seed(128)
c1<-regr_ind(as.data.frame(economics[,3:6]),as.data.frame(economics)[,2],1000,mode='linear')

set.seed(128)
c2<-regr_ind(as.data.frame(economics[,3:6]),as.data.frame(economics)[,2],1000,mode='linear',Rsq=T)

set.seed(128)
c3<-regr_ind(as.data.frame(economics[,3:6]),as.data.frame(economics)[,2],1000,mode='linear',Rsq=T,marg=0.1)
...
set.seed(129)
c1<-regr_ind(cbind(as.data.frame(mpg)[,1:7],as.data.frame(mpg)[,10:11]),as.data.frame(mpg)[,8],1000,mode='linear')

set.seed(129)
c2<-regr_ind(cbind(as.data.frame(mpg)[,1:7],as.data.frame(mpg)[,10:11]),as.data.frame(mpg)[,8],1000,mode='linear',Rsq=T)

set.seed(129)
c3<-regr_ind(cbind(as.data.frame(mpg)[,1:7],as.data.frame(mpg)[,10:11]),as.data.frame(mpg)[,8],1000,mode='linear',Rsq=T,marg=0.1)
...
set.seed(130)
c1<-regr_ind(cbind(as.data.frame(mpg)[,1:7],as.data.frame(mpg)[,10:11]),as.data.frame(mpg)[,9],1000,mode='linear')
...
set.seed(131)
c1<-regr_ind(cbind(as.data.frame(txhousing)[ind,1:3],as.data.frame(txhousing)[ind,7:8]),as.data.frame(txhousing)[ind,4],1000,mode='linear')
...
set.seed(134)
c1<-regr_ind(as.data.frame(midwest[,4:20]),as.data.frame(midwest)[,22],1000,mode='linear')
...
set.seed(135)
c1<-regr_ind(cbind(as.data.frame(diamonds[,1:6]),as.data.frame(diamonds[,8:10])),as.data.frame(diamonds)[,7],1000,mode='linear')
...
set.seed(137)
c1<-regr_ind(environmental[,2:4],environmental[,1],1000,mode='linear')
...
set.seed(138)
c1<-regr_ind(quadr(environmental[,2:4]),environmental[,1],1000,mode='linear')
...
set.seed(139)
c1<-regr_ind(Boston[,1:13],Boston[,14],1000,mode='linear')
...
set.seed(140)
c1<-regr_ind(OME[,2:5],OME[,6]/OME[,7]+0.0000001,1000,mode='linear')
...
set.seed(141)
c1<-regr_ind(Rabbit[,2:5],Rabbit[,1],1000,mode='linear')
...
set.seed(142)
c1<-regr_ind(Traffic[,1:3],Traffic[,4],1000,mode='linear')
...
set.seed(143)
c1<-regr_ind(UScereal[,2:11],UScereal[,1],1000,mode='linear')
...
set.seed(144)
c1<-regr_ind(UScrime[,1:15],UScrime[,16],1000,mode='linear')
...
set.seed(145)
c1<-regr_ind(birthwt[,1:9],birthwt[,10],1000,mode='linear')
...
set.seed(150)
c1<-regr_ind(birthwt[,2:9],birthwt[,10],1000,mode='linear')
...
set.seed(147)
c1<-regr_ind(cabbages[,1:3],cabbages[,4],1000,mode='linear')
...
set.seed(148)
c1<-regr_ind(coop[,1:3],coop[,4],1000,mode='linear')
#
...
set.seed(149)
c1<-regr_ind(cpus[,2:7],cpus[,8],1000,mode='linear')
...
set.seed(151)
c1<-regr_ind(epil[,2:9],epil[,1],1000,mode='linear')
...
set.seed(153)
c1<-regr_ind(housing[,2:5],housing[,1],1000,mode='linear')
...
set.seed(155)
c1<-regr_ind(nlschools[,2:6],nlschools[,1],1000,mode='linear')
...
set.seed(154)
c1<-regr_ind(immer[,1:3],immer[,4],1000,mode='linear')
...
set.seed(156)
c1<-regr_ind(oats[,1:3],oats[,4],1000,mode='linear')
...
set.seed(158)
c1<-regr_ind(petrol[,1:5],petrol[,6],1000,mode='linear')
...
set.seed(159)
c1<-regr_ind(quine[,1:4],quine[,5],1000,mode='linear')
...
set.seed(160)
c1<-regr_ind(road[,3:6],road[,2],1000,mode='linear')
...
set.seed(162)
c1<-regr_ind(Gasoline[,2:6],Gasoline[,1],1000,mode='linear')
...
set.seed(164)
c1<-regr_ind(MathAchieve[,c(2:4,6)],MathAchieve[,5],1000,mode='linear')
...
set.seed(165)
c1<-regr_ind(MathAchSchool[,c(2:4,6:7)],MathAchSchool[,5],1000,mode='linear')
...
set.seed(167)
c1<-regr_ind(Milk[,2:4],Milk[,1],1000,mode='linear')
...
set.seed(168)
c1<-regr_ind(Phenobarb[ind,2:5],Phenobarb[ind,6],1000,mode='linear')
...
set.seed(169)
c1<-regr_ind(cbind(quadr(cbind(Phenobarb[ind,c(2,5)],as.numeric(levels(Phenobarb[ind,3])[Phenobarb[ind,3]]))),Phenobarb[ind,4]),Phenobarb[ind,6],1000,mode='linear')
...
set.seed(171)
c1<-regr_ind(Phenobarb[ind,2:5],Phenobarb[ind,7],1000,mode='linear')
...
set.seed(172)
c1<-regr_ind(cbind(quadr(cbind(Phenobarb[ind,c(2,5)],as.numeric(levels(Phenobarb[ind,3])[Phenobarb[ind,3]]))),Phenobarb[ind,4]),Phenobarb[ind,7],1000,mode='linear')
...
set.seed(170)
c1<-regr_ind(Quinidine[ind,c(2,6:14)],Quinidine[ind,4],1000,mode='linear')
...
set.seed(173)
c1<-regr_ind(Remifentanil[ind,c(3,5:12)],Remifentanil[ind,4],1000,mode='linear')
...
set.seed(174)
c1<-regr_ind(Soybean[,2:4],Soybean[,5],1000,mode='linear')
...
set.seed(175)
c1<-regr_ind(cbind(as.numeric(Wheat[,1]),Wheat[,2:3]),Wheat[,4],1000,mode='linear')
...
set.seed(176)
c1<-regr_ind(quadr(cbind(as.numeric(levels(Wheat[,1])[Wheat[,1]]),Wheat[,2:3])),Wheat[,4],1000,mode='linear')
...
set.seed(177)
c1<-regr_ind(cbind(as.numeric(Wheat2[,1]),Wheat2[,c(2,4:5)]),Wheat2[,3],1000,mode='linear')
...
set.seed(178)
c1<-regr_ind(cbind(quadr(cbind(as.numeric(levels(Wheat2[,1])[Wheat2[,1]]),Wheat2[,4:5])),Wheat2[,2]),Wheat2[,3],1000,mode='linear',parallel=TRUE,cores=7)
...
set.seed(180)
c1<-regr_ind(tips[,c(1,3:7)],tips[,2],1000,mode='linear')
...
set.seed(181)
c1<-regr_ind(car.test.frame[ind,c(2,4:8)],car.test.frame[ind,1],1000,mode='linear')
...
set.seed(182)
c1<-regr_ind(cu.summary[ind,2:5],cu.summary[ind,1],100,mode='linear')
...
set.seed(184)
c1<-regr_ind(cancer[ind,c(1,3:10)],cancer[ind,2],1000,mode='linear')
...
set.seed(185)
c1<-regr_ind(cgd[,c(13,4:12)],cgd[,14],1000,mode='linear')
...
set.seed(186)
c1<-regr_ind(flchain[ind,c(1:8)],flchain[ind,9]+0.0000000001,1000,mode='linear')
...
set.seed(187)
c1<-regr_ind(flchain[ind,c(11,1:8)],flchain[ind,9]+0.0000000001,1000,mode='linear')
...
set.seed(188)
c1<-regr_ind(logan[,c(1,2,4)],logan[,3],1000,mode='linear')
...
set.seed(189)
c1<-regr_ind(retinopathy[,2:8],retinopathy[,9],1000,mode='linear')
...
set.seed(12398)
c0<-regr_ind(bacteria[,2:6],bacteria[,1],crv=1000,mode='binary',cutoff=0.5,objfun='roc',maxw=3)#first line of the output
#[1] 0.6674006 0.7513193

source(path2)

set.seed(12398)
c1<-regr_ind(bacteria[,2:6],bacteria[,1],crv=1000,mode='binary',cutoff=0.5,maxw=3)
#first line of the output
#[1] 0.8933668 0.8088182 0.7766364
...
set.seed(12398)
c10<-regr_ind(bacteria[,2:6],bacteria[,1],crv=1000,mode='binary',cutoff=0.5,objfun='roc',maxw=3)#first line of the output
#[1] 0.6674006 0.7513193
...
set.seed(12388)
c0<-regr_ind(Pima.te[,1:7],Pima.te[,8],crv=1000,mode='binary',cutoff=0.5,objfun='roc')
#first line of the output
...
set.seed(12388)
c1<-regr_ind(Pima.te[,1:7],Pima.te[,8],crv=1000,mode='binary',cutoff=0.5)
#first line of the output
#[1] 0.7929706 0.6693824 0.7774412
...
set.seed(12388)
c10<-regr_ind(Pima.te[,1:7],Pima.te[,8],crv=1000,mode='binary',cutoff=0.5,objfun='roc')
#first line of the output
#[1] 0.8605648 0.8553927
...
set.seed(12386)
c0<-regr_ind(pneumon[,c(1,3:12)],pneumon[,2],crv=1000,mode='binary',cutoff=0.5,objfun='roc')
#first line of the output
...
set.seed(12385)
c1<-regr_ind(pneumon[,c(1,3:12)],pneumon[,2],crv=1000,mode='binary',cutoff=0.5)
#first line of the output
#[1] 0.9922742 0.9788761 0.9781787
...
set.seed(12386)
c10<-regr_ind(pneumon[,c(1,3:12)],pneumon[,2],crv=1000,mode='binary',cutoff=0.5,objfun='roc')
#first line of the output
#[1] 0.9210679 0.9040106
...
set.seed(1248)
c0<-regr_ind(KosteckiDillon[,c(2:7,9)],KosteckiDillon[,8],crv=1000,mode='binary',cutoff=0.5, objfun='roc')
#first line of the output
...
set.seed(1238)
c1<-regr_ind(KosteckiDillon[,c(2:7,9)],KosteckiDillon[,8],crv=1000,mode='binary',cutoff=0.5)
#first line of the output
#[1] 0.6804784 0.6415457 0.6795529
...
set.seed(1248)
c10<-regr_ind(KosteckiDillon[,c(2:7,9)],KosteckiDillon[,8],crv=1000,mode='binary',cutoff=0.5, objfun='roc')
#first line of the output
#[1] 0.6665914 0.6624804
...
set.seed(1288)
c0<-regr_ind(burn[,c(2:12,14:16)],burn[,18],crv=1000,mode='binary',cutoff=0.5, objfun='roc')
#first line of the output
...
set.seed(1288)
c1<-regr_ind(burn[,c(2:12,14:16)],burn[,18],crv=1000,mode='binary',cutoff=0.5)
#first line of the output
#[1] 0.7336929 0.6950000 0.6656875
...
set.seed(1288)
c10<-regr_ind(burn[,c(2:12,14:16)],burn[,18],crv=1000,mode='binary',cutoff=0.5, objfun='roc')
#first line of the output
#[1] 0.7101131 0.5991186
...
set.seed(194)
c0<-regr_ind(beaver[,1:3],beaver[,4],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
...
set.seed(193)
c1<-regr_ind(beaver[,1:3],beaver[,4],1000,cutoff=0.5,mode='binary')
#first line of the output
#[1] 0.9643 0.3856 0.9613
...
set.seed(194)
c10<-regr_ind(beaver[,1:3],beaver[,4],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
#[1] 0.9955691 0.9881696
...
set.seed(196)
c0<-regr_ind(Aids2[,c(1,3:4,7)],Aids2[,5],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
...
set.seed(195)
c1<-regr_ind(Aids2[,c(1,3:4,7)],Aids2[,5],1000,cutoff=0.5,mode='binary')
#first line of the output
#[1] 0.9659404 0.6196702 0.9654140
...
set.seed(196)
c10<-regr_ind(Aids2[,c(1,3:4,7)],Aids2[,5],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
#[1] 0.9990844 0.9986687
...
set.seed(198)
c0<-regr_ind(Pima.tr[,1:7],Pima.tr[,8],1000,cutoff=0.5,mode='binary',maxw=5)
#first line of the output
...
set.seed(197)
c1<-regr_ind(Pima.tr[,1:7],Pima.tr[,8],1000,cutoff=0.5,mode='binary',maxw=5)
#first line of the output
#[1] 0.7804657 0.6538500 0.7530000
...
set.seed(198)
c10<-regr_ind(Pima.tr[,1:7],Pima.tr[,8],1000,cutoff=0.5,mode='binary',maxw=5)
#first line of the output
#[1] 0.8377254 0.8263776
...
set.seed(200)
c0<-regr_ind(biopsy[ind,2:10],biopsy[ind,11],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
#[1] 0.8377254 0.8263776
...
set.seed(199)
c1<-regr_ind(biopsy[ind,2:10],biopsy[ind,11],1000,cutoff=0.5,mode='binary')
#first line of the output
#[1] 0.7804657 0.6538500 0.7530000
...
set.seed(200)
c10<-regr_ind(biopsy[ind,2:10],biopsy[ind,11],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
#[1] 0.8377254 0.8263776
...
set.seed(202)
c0<-regr_ind(channing[,1:4],channing[,5],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
...
set.seed(199)
c1<-regr_ind(channing[,1:4],channing[,5],1000,cutoff=0.5,mode='binary')
#first line of the output
#[1] 0.7804657 0.6538500 0.7530000
...
set.seed(200)
c10<-regr_ind(channing[,1:4],channing[,5],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
#[1] 0.8377254 0.8263776
...
#maximising AUROC
set.seed(204)
c0<-regr_ind(cbind(channing[,1],quadr(channing[,2:4])),channing[,5],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
...
set.seed(203)
c1<-regr_ind(cbind(channing[,1],quadr(channing[,2:4])),channing[,5],1000,cutoff=0.5,mode='binary')
#first line of the output
#[1]0.7063830 0.6164468

#maximising AUROC
set.seed(204)
c10<-regr_ind(cbind(channing[,1],quadr(channing[,2:4])),channing[,5],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
#[1]0.7858406
...
set.seed(206)
c0<-regr_ind(nodal[,3:7],nodal[,2],1000,cutoff=0.5,mode='binary',objfun='roc',maxx=1)
#first line of the output
...
#maximising accuracy
set.seed(205)
c1<-regr_ind(nodal[,3:7],nodal[,2],1000,cutoff=0.5,mode='binary',maxx=1)
#first line of the output
#[[1] 0.7375 0.6190 0.7410
...
set.seed(206)
c10<-regr_ind(nodal[,3:7],nodal[,2],1000,cutoff=0.5,mode='binary',objfun='roc',maxx=1)
#first line of the output
#[1] 0.6910533 0.7781677
...
#maximising AUROC
set.seed(208)
c0<-regr_ind(quadr(nodal[,3:7]),nodal[,2],1000,cutoff=0.5,mode='binary',objfun='roc',maxx=1)
#first line of the output
...
#maximising accuracy
set.seed(207)
c1<-regr_ind(quadr(nodal[,3:7]),nodal[,2],1000,cutoff=0.5,mode='binary',maxx=1)
#first line of the output
#[1]0.7756667 0.6283333

#maximising AUROC
set.seed(208)
c10<-regr_ind(quadr(nodal[,3:7]),nodal[,2],1000,cutoff=0.5,mode='binary',objfun='roc',maxx=1)
#first line of the output
#[1] 0.7324064
...
set.seed(210)
c0<-regr_ind(urine[setdiff(1:79,c(1,55)),2:7],urine[setdiff(1:79,c(1,55)),1],1000,cutoff=0.5,mode='binary',objfun='roc',maxw=2)#first line of the output
#[1] 0.8468434 0.8437506

source(path2)

set.seed(209)
c1<-regr_ind(urine[setdiff(1:79,c(1,55)),2:7],urine[setdiff(1:79,c(1,55)),1],1000,cutoff=0.5,mode='binary',maxw=2)
#first line of the output
#[1] 0.7752381 0.5700000 0.7536250
...
set.seed(210)
c10<-regr_ind(urine[setdiff(1:79,c(1,55)),2:7],urine[setdiff(1:79,c(1,55)),1],1000,cutoff=0.5,mode='binary',objfun='roc',maxw=2)#first line of the output
#[1] 0.8468434 0.8437506
...
set.seed(210)
c0<-regr_ind(urine[setdiff(1:79,c(1,55)),2:7],urine[setdiff(1:79,c(1,55)),1],1000,cutoff=0.5,mode='binary',objfun='roc',Rsq=T,maxw=2)#first line of the output
#[1] 0.8468434 0.8437506
...
set.seed(212)
c0<-regr_ind(infert[,c(1:4,6:8)],infert[,5],1000,cutoff=0.5,mode='binary',objfun='roc',maxw=7)
#first line of the output
...
#maximising accuracy
set.seed(211)
c1<-regr_ind(infert[,c(1:4,6:8)],infert[,5],1000,cutoff=0.5,mode='binary',maxw=7)
#first line of the output
#[1] 0.7771429 0.6630000 0.7130800
...
set.seed(212)
c10<-regr_ind(infert[,c(1:4,6:8)],infert[,5],1000,cutoff=0.5,mode='binary',objfun='roc',maxw=7)
#first line of the output
#[1] 0.7674035 0.6975847
...
set.seed(214)
c0<-regr_ind(aSAH[,c(3:7)],aSAH[,2],1000,cutoff=0.5,mode='binary',objfun='roc',maxw=3)
#first line of the output
...
set.seed(213)
c1<-regr_ind(aSAH[,c(3:7)],aSAH[,2],1000,cutoff=0.5,mode='binary',maxw=3)
#first line of the output
#[1] 0.8596491 0.6375000 0.7177500
...
set.seed(214)
c10<-regr_ind(aSAH[,c(3:7)],aSAH[,2],1000,cutoff=0.5,mode='binary',objfun='roc',maxw=3)
#first line of the output
#[1] 0.7832593 0.7782922
...
set.seed(220)
c0<-regr_ind(kyphosis[,2:4],kyphosis[,1],1000,cutoff=0.5,mode='binary',objfun='roc')#first line of the output
#[1] 0.8183897 0.8180974

source(path2)

set.seed(215)
c1<-regr_ind(kyphosis[,2:4],kyphosis[,1],1000,cutoff=0.5,mode='binary')
#first line of the output
#[1] 0.791 0.791 0.791
...
set.seed(220)
c10<-regr_ind(kyphosis[,2:4],kyphosis[,1],1000,cutoff=0.5,mode='binary',objfun='roc')#first line of the output
#[1] 0.8183897 0.8180974
...
#maximising AUROC
set.seed(218)
c0<-regr_ind(quadr(kyphosis[,2:4]),kyphosis[,1],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
...
set.seed(217)
c1<-regr_ind(quadr(kyphosis[,2:4]),kyphosis[,1],1000,cutoff=0.5,mode='binary')
#first line of the output
#[1] 0.7854444 0.7854444

#maximising AUROC
set.seed(218)
c10<-regr_ind(quadr(kyphosis[,2:4]),kyphosis[,1],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
#[1] 0.8196632
...
set.seed(231)
c0<-regr_ind(stagec[ind,c(1,3:8)],stagec[ind,2],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
...
set.seed(230)
c1<-regr_ind(stagec[ind,c(1,3:8)],stagec[ind,2],1000,cutoff=0.5,mode='binary')
#first line of the output
#[1] 0.8167857 0.6353571 0.7910714
...
set.seed(231)
c10<-regr_ind(stagec[ind,c(1,3:8)],stagec[ind,2],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
#[1] 0.8869770 0.8819919
...
set.seed(233)
c0<-regr_ind(bladder[,2:5],bladder[,6],1000,cutoff=0.5,mode='binary',objfun='roc')
...
#maximising accuracy
set.seed(232)
c1<-regr_ind(bladder[,2:5],bladder[,6],1000,cutoff=0.5,mode='binary',objfun='acc')
#first line of the output
#[1] 0.7227941 0.6706471 0.7132353
...
set.seed(233)
c10<-regr_ind(bladder[,2:5],bladder[,6],1000,cutoff=0.5,mode='binary',objfun='roc')
#[1] 0.7714052 0.7630878
...
#maximising AUROC
set.seed(235)
c0<-regr_ind(quadr(bladder[,2:5]),bladder[,6],1000,cutoff=0.5,mode='binary',objfun='roc',maxw=10)
#first line of the output
...
set.seed(234)
c1<-regr_ind(quadr(bladder[,2:5]),bladder[,6],1000,cutoff=0.5,mode='binary',objfun='acc',maxw=10)
#first line of the output
#[1] 0.9117647 0.6729118 0.7175882

#maximising AUROC
set.seed(235)
c10<-regr_ind(quadr(bladder[,2:5]),bladder[,6],1000,cutoff=0.5,mode='binary',objfun='roc',maxw=10)
#first line of the output
#[1] 0.8093026 0.7703889
...
set.seed(235)
c0<-regr_ind(bladder2[,2:6],bladder2[,7],100,cutoff=0.5,mode='binary',objfun='roc')
#[1] 0.8026278 0.7786591

source(path2)

set.seed(234)
c1<-regr_ind(bladder2[,2:6],bladder2[,7],100,cutoff=0.5,mode='binary',objfun='acc')
#first line of the output
#[1] 0.7827778 0.3633333 0.7627778
...
set.seed(235)
c10<-regr_ind(bladder2[,2:6],bladder2[,7],100,cutoff=0.5,mode='binary',objfun='roc')
#[1] 0.8026278 0.7786591
...
set.seed(237)
c0<-regr_ind(cancer[ind,4:10],cancer[ind,3]-1,1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
...
set.seed(236)
c1<-regr_ind(cancer[ind,4:10],cancer[ind,3]-1,1000,cutoff=0.5,mode='binary',objfun='acc')
#first line of the output
#[1] 0.7818784 0.2757059 0.7563529
...
set.seed(237)
c10<-regr_ind(cancer[ind,4:10],cancer[ind,3]-1,1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
#[1] 0.6666318 0.6434980
...
set.seed(239)
c0<-regr_ind(cgd[,c(4:11,13,15)],cgd[,16],1000,cutoff=0.5,mode='binary',objfun='roc',maxw=6)
#[1] 0.8143154 0.7987056

source(path2)

set.seed(238)
c1<-regr_ind(cgd[,c(4:11,13,15)],cgd[,16],1000,cutoff=0.5,mode='binary',objfun='acc',maxw=6)
#first line of the output
#[1] 0.8139456 0.6245238 0.7419524
...
set.seed(239)
c10<-regr_ind(cgd[,c(4:11,13,15)],cgd[,16],1000,cutoff=0.5,mode='binary',objfun='roc',maxw=6)
#[1] 0.8143154 0.7987056
...
set.seed(241)
c0<-regr_ind(colon[ind,c(3:9,13:15)],colon[ind,16]-1,1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
...
set.seed(240)
c1<-regr_ind(colon[ind,c(3:9,13:15)],colon[ind,16]-1,1000,cutoff=0.5,mode='binary',objfun='acc')#first line of the output
#[1] 0.5521858 0.4994481 0.5458689

#maximising AUROC

set.seed(241)
c10<-regr_ind(colon[ind,c(3:9,13:15)],colon[ind,16]-1,1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
#[1] 0.5825579 0.5825579
...
set.seed(243)
c0<-regr_ind(crabs[,c(3,5:8)],crabs[,1],100,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
...
set.seed(242)
c1<-regr_ind(crabs[,c(3,5:8)],crabs[,1],1000,cutoff=0.5,mode='binary',objfun='acc')
#first line of the output
#[1] 0.98930 0.49645 0.97920
...
set.seed(243)
c10<-regr_ind(crabs[,c(3,5:8)],crabs[,1],100,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
#[1] 0.9989594 0.9958940
...
set.seed(245)
c0<-regr_ind(quine[,c(1:3,5)],quine[,4],1000,cutoff=0.5,mode='binary',objfun='roc',maxw=5)
#first line of the output
...
#maximising accuracy
set.seed(244)
c1<-regr_ind(quine[,c(1:3,5)],quine[,4],1000,cutoff=0.5,mode='binary',objfun='acc',maxw=5)
#first line of the output
#[1] 0.7358025 0.5733333 0.7224000
...
set.seed(245)
c10<-regr_ind(quine[,c(1:3,5)],quine[,4],1000,cutoff=0.5,mode='binary',objfun='roc',maxw=5)
#first line of the output
#[1] 0.8083812 0.7787639
...
set.seed(247)
c0<-regr_ind(jasa1[,c(2:3,5:8)],jasa1[,4],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
...
set.seed(246)
c1<-regr_ind(jasa1[,c(2:3,5:8)],jasa1[,4],1000,cutoff=0.5,mode='binary',objfun='acc')
#first line of the output
#[1] 0.7468235 0.5553529 0.6805882
...
set.seed(247)
c10<-regr_ind(jasa1[,c(2:3,5:8)],jasa1[,4],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
#[1] 0.8187166 0.7484923
...
set.seed(249)
c0<-regr_ind(mgus2[ind,2:8],mgus2[ind,11],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
...
set.seed(248)
c1<-regr_ind(mgus2[ind,2:8],mgus2[ind,11],1000,cutoff=0.5,mode='binary',objfun='acc')
#first line of the output
#[1] 0.7952910 0.3013806 0.7897164
...
set.seed(249)
c10<-regr_ind(mgus2[ind,2:8],mgus2[ind,11],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
#[1] 0.8426302 0.8393732
...
set.seed(251)
c0<-regr_ind(nwtco[,c(2:5,7:8)],nwtco[,6],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
...
#maximising accuracy
set.seed(250)
c1<-regr_ind(nwtco[,c(2:5,7:8)],nwtco[,6],1000,cutoff=0.5,mode='binary',objfun='acc')
#first line of the output
#[1] 0.9313375 0.8579553 0.9240918
...
set.seed(251)
c10<-regr_ind(nwtco[,c(2:5,7:8)],nwtco[,6],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
#[1] 0.9664795 0.9584666
...
set.seed(253)
c0<-regr_ind(retinopathy[,c(2:7,9)],retinopathy[,8],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
...
#maximising accuracy
set.seed(252)
c1<-regr_ind(retinopathy[,c(2:7,9)],retinopathy[,8],1000,cutoff=0.5,mode='binary',objfun='acc')
#first line of the output
#[1] 0.823850 0.606325 0.816175
...
set.seed(253)
c10<-regr_ind(retinopathy[,c(2:7,9)],retinopathy[,8],1000,cutoff=0.5,mode='binary',objfun='roc')
#first line of the output
#[1] 0.8865818 0.8789591
